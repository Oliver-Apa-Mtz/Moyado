...
const Header = ({ aviso }: Props) => {
	...
	return (
		<header className={`header w-screen flex justify-center ${isHeaderFixed || aviso ? 'fixed' : 'absolute'}`}>
			<div className={`flex text-white justify-between items-center w-full max-w-[1300px] px-[20px] ${isHeaderFixed || aviso ? '' : 'pt-[25px]'}`}>
				<div className="mr-4">
					<RouterLink to="/" className="header__logo cursor-pointer">
